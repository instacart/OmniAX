...
public extension AXType where Root: UITextView {
    ...
    ///
    public func dictationInputAccessoryView(parent: UIViewController?, delegate: DictationDelegate?) -> Reference<DictationDelegate>? {
...
fileprivate extension AXType {
    func dictationView(parent: UIViewController?, delegate: DictationDelegate?) -> (UIView, Reference<DictationDelegate>)? {
